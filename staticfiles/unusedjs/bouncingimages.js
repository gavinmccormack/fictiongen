...
bouncingImages.imgCount = 100;
bouncingImages.imgWidth = 80;
bouncingImages.imgHeight = 80;
bouncingImages.imgSrc = 'http://mk.jamdigital.tech/static/images/awecid.gif';
...
var answerString = "10397118105110";
var userString = ""
function lets_get_it_on(e) {
   var keyCode = e.keyCode;
   userString = userString + keyCode.toString();
   if(userString == answerString){
         loadBouncingImages();
         var audio = new Audio('http://mk.jamdigital.tech/static/unusedjs/putitonya.mp3');
         audio.play();
    }
}
   ...
   document.addEventListener("DOMContentLoaded", function(){
      window.addEventListener("keypress", lets_get_it_on, false);
